var Login = function () {
    ...
    return {
        init: function () {
            r(), $(".login-bg").backstretch(["assets/admin/assets/pages/img/login/bg1.jpg", "assets/admin/assets/pages/img/login/bg1.jpg", "assets/admin/assets/pages/img/login/bg1.jpg"], {
                fade: 1e3,
                duration: 8e3
            }), $(".forget-form").hide()
        }
