        ...
        <div class="page-wrapper">
            ...
            <div class="page-header navbar navbar-fixed-top">
                ...
                <div class="page-header-inner ">
                    ...
                    <div class="page-logo">
                        <a href="#">
                            <img src="<?=base_url().$config_update['DashboardImagePath']?>" height="<?=$config_update['DashboardHeight']?>"
                             width="<?=$config_update['DashboardWidth']?>" style="padding:<?=$config_update['DashboardPadding']?>;">
...
?>
                                    ...
                                    <li>
                                        <ul class="dropdown-menu-list scroller" style="height: 275px;" data-handle-color="#637283">
                                            <li>
                                                <a href="#">
                                                    <span class="photo">
                                                        <img src="<?=base_url() . 'assets/admin/assets/'?>layouts/layout3/img/avatar2.jpg" class="img-circle" alt=""> </span>
                                                    <span class="subject">
                                            ...
                                            <li>
                                                <a href="#">
                                                    <span class="photo">
                                                        <img src="<?=base_url() . 'assets/admin/assets/'?>layouts/layout3/img/avatar3.jpg" class="img-circle" alt=""> </span>
                                                    <span class="subject">
                                            ...
                                            <li>
                                                <a href="#">
                                                    <span class="photo">
                                                        <img src="<?=base_url() . 'assets/admin/assets/'?>layouts/layout3/img/avatar1.jpg" class="img-circle" alt=""> </span>
                                                    <span class="subject">
                            ...
                            <li class="dropdown dropdown-user">
                                <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown" data-hover="dropdown" data-close-others="true">
                                    <img alt="" class="img-circle" src="<?=base_url().$change_profile['ProfilePic']?>" />
                                    <span class="username username-hide-on-mobile"><?= $personal_info_updation['FirstName']?> </span>
                                ...
                                <ul class="dropdown-menu dropdown-menu-default">
                                    ...
                                    <li>
                                        <a href=<?=base_url() . 'common/Login/logout'?>>
