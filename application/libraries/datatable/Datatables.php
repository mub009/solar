  ...
  */
  class Datatables
  {
    ...
    */
    ...
    // public function add_columntwo($column, $content, $match_replacement = NULL)
    // {
    //   $this->add_columns[$column] = array('content' => $content, 'replacement' => $this->explode(',', $match_replacement));
     
    //  print_r($this->add_columns[$column]);
    //   die();
    //   return $this;
    // }
    ...
    * @return mixed
    */
    public function edit_view($column, $content, $match_replacement)
    {
      $this->edit_columns[$column][] = array('content' =>"<center><a href='".base_url($content)."' data-toggle='modal' data-target='#basic'><i class='icon-eye'></i> </a></center>", 'replacement' => $this->explode(',', $match_replacement));
      return $this;
    }
    ...
    */
    ...
    public function edit_tracking($column, $content, $match_replacement)
    {
      $this->edit_columns[$column][] = array('content' =>$this->ci->load->view('template/TemplateTools/tracking',$content,true), 'replacement' => $this->explode(',', $match_replacement));
      return $this;
    }
    ...
    */
    ...
    public function edit_image($column, $content, $match_replacement)
    {
      $this->edit_columns[$column][] = array('content' =>"<center></center><img src='".$content."' alt='image'></center>", 'replacement' => $this->explode(',', $match_replacement));
      return $this;
    }
    ...
    * @return mixed
    */
    public function edit_view_link($column, $content, $match_replacement)
    {
      $this->edit_columns[$column][] = array('content' =>"<center><a href='".base_url($content)."' ><i class='icon-eye'></i> </a></center>", 'replacement' => $this->explode(',', $match_replacement));
      return $this;
    }
    ...
    * @return mixed
    */
    public function edit_link($column, $content, $match_replacement)
    {
      $this->edit_columns[$column][] = array('content' =>"<a href='".base_url($content)."/$1' >$2</a>", 'replacement' => $this->explode(',', $match_replacement));
      return $this;
    }
    ...
    * @return mixed
    */
    public function edit_column_link($column, $content, $match_replacement)
    {
      $this->edit_columns[$column][] = array('content' =>$this->ci->load->view('template/TemplateTools/column_link',$content,true), 'replacement' => $this->explode(',', $match_replacement));
      return $this;
    }
    ...
    * @return mixed
    */
    public function column_right_side($column, $content, $match_replacement)
    {
      $this->edit_columns[$column][] = array('content' => "<p align='right'>$i</p>", 'replacement' => $this->explode(',', $match_replacement));
      return $this;
    }
    ...
    * @return mixed
    */
    public function edit_column_item($column, $content, $match_replacement)
    {
      $this->edit_columns[$column][] = array('content' =>$this->ci->load->view('template/TemplateTools/column_item',$content,true), 'replacement' => $this->explode(',', $match_replacement));
      return $this;
    }
    ...
    * @return mixed
    */
    public function edit_action($column, $content, $match_replacement)
    {
      $this->edit_columns[$column][] = array('content' =>$this->ci->load->view('template/TemplateTools/action',$content,true), 'replacement' => $this->explode(',', $match_replacement));
      return $this;
    }
    ...
    * @return mixed
    */
    public function edit_TemplateAdd($column, $content, $match_replacement)
    {
        $this->edit_columns[$column][] = array('content' =>$this->ci->load->view('template/TemplateTools/report/loyaltyreport',$content,true), 'replacement' => $this->explode(',', $match_replacement));
        return $this;
    }
    ...
    */
    ...
    public function edit_LoyalityLedger($column, $content, $match_replacement)
    {
        $this->edit_columns[$column][] = array('content' =>$this->ci->load->view('template/TemplateTools/report/loyaltyreport', array('LoyaltyStatus'=>"$2"),true), 'replacement' => $this->explode(',', $match_replacement));
        return $this;
    }
